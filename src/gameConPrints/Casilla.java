...
public class Casilla {
	...
	private void eligeAccion (int [] genoma){
		...
		//System.out.print("Gen de prioridad utilizado: " + genPrioridad);
		switch (genPrioridad) {
			case 3:
		...
		System.out.println("\ngame.Casilla "+ Arrays.toString(this.coordenadas) + "Acción realizada: " + accionRealizada + result);
	}
		...
		switch (politica) {
			...
			case 1:
				...
				if (casillaDestino != null && this.getPobMilitar() > 3) {
					System.out.print("Se va a atacar a "+ Arrays.toString(casillaDestino.getCoordenadas()));
	...
	public int moverPoblacion (Casilla casillaDestino, int civiles, int militares) {
		...
		System.out.println("SE MUEEEEEEEEEEEEVEN");
		...
		while ( (civilesMovidos < civiles)
			...
			//System.out.println("Entró al bucle 1");
			this.subPobCivil(1);
		...
		while (civilesMovidos < civiles
			...
			//System.out.println("Entró al bucle 2");
			this.subPobCivil(1);
			casillaDestino.addPobCivil(1);
			civilesMovidos ++;
		} */
		...
		while (militaresMovidos < militares
			...
			//System.out.println("Entró al bucle 3");
			this.subPobMilitar(1);
			casillaDestino.addPobMilitar(1);
			militaresMovidos ++;
		} */
		System.out.println("SE HAN MOVIDO " + (civilesMovidos+militaresMovidos));
